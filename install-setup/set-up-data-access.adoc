...
ASA r2 스토리지 유닛은 기본적으로 씬 프로비저닝됩니다.  VM 워크로드를 마이그레이션할 때 가상 디스크(VMDK)도 씬 프로비저닝해야 합니다.
...
* 자세히 알아보세요link:https://kb.netapp.com/on-prem/ontap/da/SAN/SAN-KBs/How_to_setup_Broadcom_VMware_ESXi_iSCSI_MPIO_with_ONTAP_SAN_ASA["ONTAP SAN ASA 스토리지 시스템에 Broadcom VMware ESXi iSCSI MPIO를 설정하는 방법"^] .
...
ONTAP 9.19.1부터 FLI는 백엔드 연결을 위해 iSCSI 프로토콜을 지원합니다.

* link:https://docs.netapp.com/us-en/ontap-fli/get-started/learn-about-data-migration.html["ONTAP FLI 마이그레이션"^]에 대해 자세히 알아보십시오.
