...
| 시스템  a| 
다음 NetApp ASA r2 시스템은 ONTAP 9.16.1부터 지원됩니다. 이러한 시스템은 SAN 전용 고객의 요구 사항에 맞춰 간소화된 환경을 만드는 통합 하드웨어 및 소프트웨어 솔루션을 제공합니다.
...
| link:../learn-more/additional-supported-ontap-features.html#san-protocols["NVMe 공간 할당 취소가 기본적으로 활성화되어 있습니다"]  a| 
